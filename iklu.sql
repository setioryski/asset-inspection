...
-- Dumping data for table web1.role: ~2 rows (approximately)
INSERT INTO `role` (`role_id`, `role_name`) VALUES
	(1, 'admin'),
	(2, 'petugas');

-- Dumping data for table web1.tipe_aset: ~89 rows (approximately)
...
-- Dumping data for table web1.tipe_door: ~95 rows (approximately)
...
-- Dumping data for table web1.tipe_hb: ~173 rows (approximately)
...
-- Dumping data for table web1.tipe_kondisi: ~3 rows (approximately)
